...
import { useSlotAvailability } from '@/features/admission/hooks/use-slot-availability';
import { useSessionValidation } from '@/features/admission/hooks/use-session-validation';
